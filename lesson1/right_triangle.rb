...
answer = ""
# Сначала проверяем полученные данные
if hypotenuse<=0 || leg1<=0 || leg2<=0
  puts "ERROR: Стороны не могут быть не положительными"
# Если все ОК, то проверяем на равносторонность, если истинна пропускаем все остальные условия и показываем ответ
